...
export declare const ServerMessageEndOfCallReportEndedReason: {
    ...
    readonly CallStartErrorEnterpriseFeatureNotAvailableRecordingConsent: "call.start.error-enterprise-feature-not-available-recording-consent";
    readonly AssistantNotValid: "assistant-not-valid";
    readonly CallStartErrorVapifaultDatabaseError: "call.start.error-vapifault-database-error";
    ...
    readonly PipelineErrorVapiVoiceFailed: "pipeline-error-vapi-voice-failed";
    ...
    readonly CallInProgressErrorVapifaultVapiVoiceFailed: "call.in-progress.error-vapifault-vapi-voice-failed";
    ...
    readonly CallInProgressErrorPipelineWsModelConnectionFailed: "call.in-progress.error-pipeline-ws-model-connection-failed";
    ...
    readonly CallInProgressErrorProviderfaultElevenLabsSystemBusyAndRequestedUpgrade: "call.in-progress.error-providerfault-eleven-labs-system-busy-and-requested-upgrade";
    ...
    readonly CustomerEndedCallBeforeWarmTransfer: "customer-ended-call-before-warm-transfer";
    ...
    readonly CallDeleted: "call-deleted";
};
export type ServerMessageEndOfCallReportEndedReason = (typeof ServerMessageEndOfCallReportEndedReason)[keyof typeof ServerMessageEndOfCallReportEndedReason];
